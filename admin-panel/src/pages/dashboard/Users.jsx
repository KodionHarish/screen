...
//   // Better ref management for textarea
...
//     try {
//       const res = await axios.get("http://localhost:5000/api/users/usersLogs", {
//         withCredentials: true,
//       });
//       console.log(res, "res");
...
//       e.preventDefault();
//       if (!isLoading && notificationMessage.trim()) {
//         sendNotification();
//       }
//     }
//   };
...
//                 flexWrap: 'nowrap',
//               },
//               // You might also need to limit the width of individual chips if names are very long
//               '.MuiAutocomplete-tag': {
...
//                 minWidth: '30px !important', // Prevent input from taking too much space
//               },
...
//         onBackdropClick={isLoading ? undefined : handleCloseModal}
//       >
//         <DialogTitle sx={{ pb: 1 }}>
//           <Box
//             display="flex"
...
//             disabled={isLoading || selectedUser?.activeStatus}
//             variant="outlined"
//             color="secondary"
//             sx={{ ml: "auto" }}
//           >
...
const UsersAll = () => {
  ...
  // const [showNotificationModal, setShowNotificationModal] = useState(false);
  // const [unreadCount, setUnreadCount] = useState(0);
  // const [userAlerts, setUserAlerts] = useState({}); // Track alerts per user
  ...
  // const getUserNameById = (userId) => {
  //   console.log(users,userId,"lllllllllllllll")
  //   const user = users.find((u) => u.id === userId);
  //   return user ? user.name : "Unknown User";
  // };
